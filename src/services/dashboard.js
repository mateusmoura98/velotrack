...
export const dashboardService = {
  ...
  restartTestEnvironment: async () => {
    // Admin action: deletes test OS (and fallbacks to delete all if no is_test=true records)
    // To ensure the dashboard is actually cleared when user requests to clear.
